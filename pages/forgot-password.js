const ForgotPassword = () => {
  return (
    <div className="relative bg-dark-1 w-full h-[801px] overflow-hidden text-center text-mid text-white font-body-regular">
      <div className="absolute top-[521px] left-[0px] bg-gray-200 [backdrop-filter:blur(54.37px)] w-[375px] h-[291px] text-3xl-5 font-sf-pro-text">
        <img
          className="relative w-[15px] h-[25px]"
          alt=""
          src="/dictation.svg"
        />
        <img
          className="relative w-[26.5px] h-[26.5px]"
          alt=""
          src="/emoji.svg"
        />
      ...
      <div className="absolute top-[439px] left-[56px] w-[263px] h-[50px] text-black">
        <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-3xl bg-primary" />
        <div className="absolute top-[calc(50%_-_11px)] left-[calc(50%_-_20.5px)] font-semibold">
          Send
        </div>
      </div>
      <div className="absolute top-[222px] left-[32px] w-[311px] h-[60px] text-left">
        <img
      ...
      <div className="absolute top-[114px] left-[32px] w-[286px] h-[293px] text-left text-5xl font-integral-cf">
